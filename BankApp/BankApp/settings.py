...
DATABASE_URL = "postgresql://postgres:cFbqlHcxaaXnwagbwXnctQLldtxRnkXm@postgres.railway.internal:5432/railway"
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'Banking/media')